                        ...
                        <div key={update.id} className={`bg-white rounded-xl border border-stone-100 shadow-sm overflow-hidden animate-fade-up stagger-${(i % 4) + 1}`}>
                            ...
                            <div className="p-5">
                                ...
                                <div className="flex items-center gap-3 pt-3 border-t border-stone-100">
                                    ...
                                    <button className="flex items-center gap-1.5 text-sm font-bold text-stone-400 hover:text-blue-500 transition-colors">
                                        <span className="material-symbols-outlined">chat_bubble</span>
                                        {update.comments_count}
                                    </button>
                                    <button className="ml-auto flex items-center gap-1.5 text-sm font-bold text-stone-400 hover:text-primary transition-colors">
