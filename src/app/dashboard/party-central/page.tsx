...
export default function PartyCentralPage() {
    ...
    return (
        <div className="flex h-screen overflow-hidden bg-background-dark text-cream font-sans selection:bg-primary selection:text-background-dark">
            ...
            <aside className={`absolute z-50 md:relative w-64 bg-[#0d0f1a] border-r border-primary/20 flex flex-col shrink-0 h-screen transform transition-transform duration-300 ${isSidebarOpen ? "translate-x-0" : "-translate-x-full md:translate-x-0"}`}>
            ...
            <main className="flex-1 flex flex-col min-w-0 bg-background-dark relative">
                ...
                {/* Header */}
                <header className="h-20 border-b border-white/10 bg-background-dark/90 backdrop-blur-md flex items-center justify-between px-4 sm:px-8 shrink-0 z-10 sticky top-0">
                    <div className="flex items-center gap-3">
                        <button className="md:hidden text-white" onClick={() => setIsSidebarOpen(!isSidebarOpen)}>
                            <Icon name="menu" size={24} />
                        </button>
                        <h2 className="font-serif text-lg sm:text-2xl font-bold tracking-tight text-cream">
                            National Dashboard
                        </h2>
                    </div>
                    <div className="flex items-center gap-3 sm:gap-6">
                        <div className="hidden md:block relative group">
                            ...
                            <input
                                className="bg-[#111520] border border-white/10 rounded-md pl-10 pr-4 py-2 w-48 lg:w-80 text-sm text-cream placeholder-white/20 focus:border-primary focus:ring-1 focus:ring-primary transition-all font-mono outline-none"
                        ...
                        <div className="hidden sm:flex flex-col items-end border-r border-white/10 pr-6 mr-2">
                            ...
                            <div className="text-[9px] lg:text-[10px] text-white/60 uppercase tracking-widest">
                                New Delhi HQ
                            </div>
                        </div>
                        <button className="bg-saffron hover:bg-[#d6650a] text-white px-3 py-2 sm:px-5 sm:py-2.5 rounded font-mono font-medium text-xs uppercase tracking-wider flex items-center gap-1 sm:gap-2 transition-all shadow-lg hover:-translate-y-px active:translate-y-0">
                ...
                <div className="flex-1 overflow-y-auto p-4 sm:p-8 z-10 custom-scrollbar">
                    ...
                    <div className="flex flex-col xl:grid xl:grid-cols-12 gap-6 mb-8 xl:h-[500px]">
                        {/* State Performance */}
                        <div className="xl:col-span-3 bg-[#111520] border border-white/10 rounded flex flex-col h-[300px] xl:h-auto overflow-hidden">
                        ...
                        {/* Live Feed */}
                        <div className="xl:col-span-5 bg-[#111520] border border-white/10 rounded flex flex-col h-[400px] xl:h-auto overflow-hidden relative">
                            <div className="p-4 border-b border-white/10 flex justify-between items-center bg-[#161b28]">
                    ...
                    <div className="flex flex-col xl:grid xl:grid-cols-3 gap-6 xl:h-[300px]">
                        ...
                        <div className="xl:col-span-2 h-[250px] xl:h-auto bg-[#111520] border border-primary/20 rounded p-5 relative">
                        ...
                        <div
                            className="xl:col-span-1 h-[250px] xl:h-auto bg-[#111520] border border-white/10 rounded p-5 relative flex flex-col items-center justify-center"
                            style={{
