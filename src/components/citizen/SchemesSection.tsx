    ...
    return (
        <div className="pt-8 pb-4">
            <div className="px-5 flex items-center justify-between mb-4">
                ...
                <Link href="/citizen/schemes" className="text-primary text-sm font-bold hover:underline">View All</Link>
            </div>
            ...
            <div className="flex overflow-x-auto gap-4 px-5 pb-4 no-scrollbar snap-x snap-mandatory">
                ...
                <div className="snap-center shrink-0 w-[280px] bg-white rounded-xl p-4 shadow-card border border-stone-100 flex flex-col justify-between h-[180px]">
                    ...
                    <Link href="/citizen/schemes" className="pt-3 mt-auto border-t border-stone-100 flex justify-between items-center group cursor-pointer block">
                        <span className="text-xs font-bold text-primary uppercase tracking-wide group-hover:underline">Apply Now</span>
                        <span className="material-symbols-outlined text-primary text-sm transition-transform group-hover:translate-x-1 relative top-0.5">arrow_forward</span>
                    </Link>
                </div>
