...
export default function ManagerSidebar({ isOpen = false }: { isOpen?: boolean }) {
    ...
    return (
        <aside className={`absolute z-50 md:relative w-64 bg-[#0d0f1a] border-r border-[rgba(201,168,76,0.14)] flex flex-col flex-shrink-0 h-screen transform transition-transform duration-300 ${isOpen ? "translate-x-0" : "-translate-x-full md:translate-x-0"}`}>
            {/* Brand */}
